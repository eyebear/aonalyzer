...
def _default_rows(settings: AppSettings) -> list[dict[str, Any]]:
    return [
        {"provider_type": DISABLED, "display_name": "Disabled", "is_enabled": True,
         "base_url": None, "model": None, "api_key_env": None},
        {"provider_type": MANUAL_PASTE, "display_name": "Manual Paste", "is_enabled": True,
         "base_url": None, "model": None, "api_key_env": None},
        {"provider_type": FREE_WEB_AI, "display_name": "Free Web AI", "is_enabled": True,
         "base_url": None, "model": None, "api_key_env": None},
        {"provider_type": GEMINI, "display_name": "Google Gemini", "is_enabled": True,
         "base_url": None, "model": settings.gemini_model, "api_key_env": "GEMINI_API_KEY"},
        {"provider_type": GROK, "display_name": "Grok (xAI)", "is_enabled": True,
         "base_url": "https://api.x.ai/v1", "model": settings.grok_model, "api_key_env": "GROK_API_KEY"},
        {"provider_type": OPENAI_COMPATIBLE, "display_name": "OpenAI-compatible", "is_enabled": True,
         "base_url": settings.openai_compatible_base_url or None,
         "model": settings.openai_compatible_model, "api_key_env": "OPENAI_API_KEY"},
        {"provider_type": OLLAMA, "display_name": "Ollama (local)", "is_enabled": True,
         "base_url": settings.ollama_base_url, "model": settings.ollama_model, "api_key_env": None},
        {"provider_type": LOCAL_LLM, "display_name": "Local LLM", "is_enabled": True,
         "base_url": settings.local_llm_base_url, "model": settings.local_llm_model, "api_key_env": None},
        {"provider_type": CUSTOM, "display_name": "Custom", "is_enabled": True,
         "base_url": settings.custom_provider_base_url or None,
         "model": settings.custom_provider_model or None, "api_key_env": "CUSTOM_PROVIDER_API_KEY"},
    ]
